...
public class LopController {
    private final ILopService service;

    @GetMapping()
    public ResponseObject<List<Lop>> getAll(HttpServletRequest request) {
        try {
    ...
    @GetMapping("/{id}")
    public ResponseObject<Lop> getById(@PathVariable Integer id, HttpServletRequest request) {
        try {
    ...
    @PostMapping()
    public ResponseObject<Lop> post(@RequestBody Lop data, HttpServletRequest request) {
        try {
    ...
    @PutMapping()
    public ResponseObject<Lop> putById(@RequestBody Lop data, HttpServletRequest request) {
        try {
